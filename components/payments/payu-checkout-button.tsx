...
export function PayUCheckoutButton({
  ...
  async function checkout() {
    ...
    form.method = "POST";
    form.action = body.endpoint;
    Object.entries(body.fields as Record<string, string>).forEach(([name, value]) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Continue to PayU</DialogTitle>
          <DialogDescription>
            PayU requires a valid mobile number for payment security and fraud prevention.
          </DialogDescription>
        </DialogHeader>
        <input
          value={phone}
          ...
          aria-label="Mobile number for PayU checkout"

...
import { checkoutHash, newTransactionId, paymentEndpoint, payUIsConfigured, planDetails, type PaidPlan } from "@/lib/payments/payu";
...
export async function POST(request: NextRequest) {
  ...
  const udf1 = user.id; const udf2 = body.plan;
